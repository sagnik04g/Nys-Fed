...
def get_clients_and_model(args: argparse.Namespace) -> tuple[list[object], list[object], torch.nn.Module]:
    ...
    match args.project:
        case 'fednys-femnist' | 'fed-done-femnist' | 'fed-admm-femnist' | 'fednys-admm-femnist' | 'fed-femnist' | 'fed-done-femnist':
        ...
        case 'fednys-cinic10' | 'fed-done-cinic10' | 'fed-admm-cinic10' | 'fednys-admm-cinic10' | 'fed-cinic10' | 'fed-done-cinic10':
        ...
        case 'fednys-w8a' | 'fed-done-w8a' | 'fed-admm-w8a' | 'fednys-admm-w8a'| 'fed-w8a' | 'fed-ns-w8a' | 'fed-done-w8a':
        ...
        case 'fednys-phishing'| 'fed-done-phishing' | 'fed-admm-phishing' | 'fednys-admm-phishing'| 'fed-phishing' | 'fed-ns-phishing' | 'fed-done-phishing':
        ...
        case 'fednys-realsim' | 'fed-done-realsim' | 'fed-admm-realsim' | 'fednys-admm-realsim'| 'fed-realsim' | 'fed-ns-realsim' | 'fed-done-realsim':
        ...
        case 'fednys-shakespeare' | 'fed-done-shakespeare' | 'fed-done-femnist' | 'fed-admm-shakespeare' | 'fednys-admm-shakespeare'| 'fed-shakespeare' | 'fed-ns-shakespeare' | 'fed-done-shakespeare':
...
def default_setting(args: argparse.Namespace) -> None:
    ...
    match args.project:
        ...
        case 'fednys-cinic10' | 'fed-done-cinic10' | 'fed-admm-cinic10' | 'fednys-admm-cinic10' | 'fed-cinic10':
            args.min_sample = 128
            args.global_bs  = 128
            args.client_bs  = 128
            args.client_lr  = 0.05
        ...
        case 'fednys-femnist' | 'fed-done-femnist' |'fed-admm-femnist' | 'fednys-admm-femnist' | 'fed-femnist':
            args.min_sample = 128
            args.global_bs  = 128
            args.client_bs  = 128
            args.client_lr  = 1e-1
        ...
        case 'fednys-realsim' | 'fed-admm-realsim' | 'fednys-admm-realsim' | 'fed-realsim' | 'fed-ns-realsim':
            args.min_sample = 256
            args.global_bs  = 256
            args.client_bs  = 256
            args.client_lr  = 1
        ...
        case 'fednys-shakespeare' | 'fed-admm-shakespeare' | 'fednys-admm-shakespeare' | 'fed-shakespeare' | 'fed-ns-shakespeare':
            args.min_sample = 256
            args.global_bs  = 256
            args.client_bs  = 256
            args.client_lr  = 1
