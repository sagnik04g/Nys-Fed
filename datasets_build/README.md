...
The non-iid Shakespeare dataset can be obtained from https://leaf.cmu.edu/ together with bash code for reproducible data split.

## Download teh cinic10 dataset from 
